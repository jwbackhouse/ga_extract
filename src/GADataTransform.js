...
const getGAData = async (hostname, protocol, path, token, coordinate) => {
  ...
  const formattedRequestURLForCoordinateAsString = `${protocol}://${hostname}/${path}/?ids=ga%3A89883654&start-date=2014-09-01&end-date=yesterday&metrics=ga%3Apageviews&dimensions=ga%3Adate&filters=ga%3ApagePath%3D%40${coordinate.term}&access_token=${token}`
